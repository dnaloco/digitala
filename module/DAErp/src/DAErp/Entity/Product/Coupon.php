...
use DACore\Entity\Erp\Product\CouponInterface;

/**
 *
 * @ORM\Table(name="daerp_product_coupons")
 * @ORM\Entity
 */
class Coupon implements CouponInterface
{
	...
	/**
	 * @ORM\ManyToMany(targetEntity="DACore\Entity\Erp\Product\MixProductInterface")
	...
	/**
	 * @ORM\ManyToMany(targetEntity="DACore\Entity\Erp\Product\DepartmentInterface")
	...
	/**
	 * @ORM\ManyToMany(targetEntity="DACore\Entity\Erp\Product\CategoryInterface")
