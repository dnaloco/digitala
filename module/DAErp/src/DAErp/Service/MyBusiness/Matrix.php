<?php
namespace DAErp\Service\MyBusiness;
...
class Matrix extends AbstractCrudService
implements
...
MyUploadAwareInterface
{
	...
	public function prepareData(array $data)
	{
		...
		if (!isset($data['company'])) {
			...
			$type = $this->getAnotherRepository('DACore\IEntities\Base\CompanyTypeInterface')->findOneBy(array('name' => 'matrix'));
