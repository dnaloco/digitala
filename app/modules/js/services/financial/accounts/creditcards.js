function CreditCardAccountsService(Restangular) {
  'ngInject';

  var privateUrl = 'private/financial/accounts/credit-cards';
...
export default {
  name: 'CreditCardAccountsService',
  fn: CreditCardAccountsService
};
