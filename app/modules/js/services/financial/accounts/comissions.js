function ComissionAccountsService(Restangular) {
  'ngInject';

  var privateUrl = 'private/financial/accounts/comissions';
...
export default {
  name: 'ComissionAccountsService',
  fn: ComissionAccountsService
};
