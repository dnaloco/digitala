function InvestimentAccountsService(Restangular) {
  'ngInject';

  var privateUrl = 'private/financial/accounts/investiments';
...
export default {
  name: 'InvestimentAccountsService',
  fn: InvestimentAccountsService
};
