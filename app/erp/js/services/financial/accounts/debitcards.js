function DebitCardAccountsService(Restangular) {
  'ngInject';

  var privateUrl = 'private/financial/accounts/debit-cards';
...
export default {
  name: 'DebitCardAccountsService',
  fn: DebitCardAccountsService
};
